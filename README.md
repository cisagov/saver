...
```console
docker run cisagov/saver:1.4.1
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/saver:1.4.1
    ```
...
|-----------|-------------|
|`cisagov/saver:1.4.1`| An exact release version. |
