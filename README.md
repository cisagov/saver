...
```console
docker run cisagov/saver:1.4.0
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/saver:1.4.0
    ```
...
|-----------|-------------|
|`cisagov/saver:1.4.0`| An exact release version. |
