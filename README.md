...
```console
docker run cisagov/saver:1.4.2
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/saver:1.4.2
    ```
...
|-----------|-------------|
|`cisagov/saver:1.4.2`| An exact release version. |
