...
```console
docker run cisagov/saver:1.3.0-rc.1
```
...
1. Create a `docker-compose.yml` file similar to the one below to use [Docker Compose](https://docs.docker.com/compose/).
    ...
    services:
      saver:
        image: cisagov/saver:1.3.0-rc.1
        volumes:
          - type: bind
            source: <your_log_dir>
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/saver:1.3.0-rc.1
    ```
...
|-----------|-------------|
|`cisagov/saver:1.3.0-rc.1`| An exact release version. |
