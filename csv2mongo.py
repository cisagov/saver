...
REWRITES_FILE = INCLUDE_DATA_DIR + 'include/rewrites.csv'
NON_CYHY_STAKEHOLDERS_FILE = INCLUDE_DATA_DIR + 'include/noncyhy.csv'
AGENCIES_FILE = INCLUDE_DATA_DIR + 'include/agencies.csv'

CURRENT_FEDERAL_FILE = INCLUDE_DATA_DIR + 'artifacts/current-federal-original.csv'
UNIQUE_AGENCIES_FILE = INCLUDE_DATA_DIR + 'artifacts/unique-agencies.csv'
CLEAN_CURRENT_FEDERAL_FILE = INCLUDE_DATA_DIR + 'artifacts/clean-current-federal.csv'

PSHTT_RESULTS_FILE = INCLUDE_DATA_DIR + 'artifacts/results/pshtt.csv'
TRUSTYMAIL_RESULTS_FILE = INCLUDE_DATA_DIR + 'artifacts/results/trustymail.csv'
SSLYZE_RESULTS_FILE = INCLUDE_DATA_DIR + 'artifacts/results/sslyze.csv'
